    ...
    <>
      ...
      <section id="s1" data-dc-section className={cn(styles.section, styles.sectionA)}>
        <div className={styles.container}>
          ...
          <p className={styles.pLead}>
            ...
            livrer une <Strong>plateforme de mise en relation pour l’hôtellerie</Strong> (l’«
            Application »), sur application mobile et interface web, pour le compte du client
      ...
      <section id="s2" data-dc-section className={cn(styles.section, styles.sectionB)}>
        <div className={styles.container}>
          ...
          <SubHeading>Paiements, hébergement & mise en ligne</SubHeading>
      ...
      <section id="s3" data-dc-section className={cn(styles.section, styles.sectionA)}>
        <div className={styles.container}>
            ...
            <table className={styles.table}>
              ...
              <tbody>
                ...
                <tr className={styles.tableTotal}>
                  ...
                  <td className={styles.tableTotalAmount}>4 950 €</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <InfoBox icon="€" title="Aucune taxe applicable">
            ...
            <Strong>Le montant de 4 950 € correspond au montant net à payer.</Strong>
          </InfoBox>
          ...
          <p style={{ fontSize: "13px", color: "var(--slate)", margin: 0, lineHeight: 1.6 }}>
            ...
            Aucun travail de développement ne débute avant réception de l’acompte. Le modèle de
            revenus de l’Application : abonnement <Strong>6,99 €/mois</Strong> (professionnel, essai
            3 j) et <Strong>3,99 €/publication</Strong> côté établissement (1ʳᵉ offerte) — sans
        ...
        <div className={styles.container}>
          ...
          <div className={styles.guarantee}>
            ...
            <div className={styles.guaranteeStats}>
              <div>
                <div className={styles.guaranteeStatValue}>&lt; 0,35 €</div>
                <div className={styles.guaranteeStatLabel}>
                  par professionnel <b>abonné payant</b>
                </div>
              </div>
              <div>
                <div className={styles.guaranteeStatValue}>≈ 10 €</div>
                <div className={styles.guaranteeStatLabel}>
                  par établissement réalisant une <b>publication payante</b>
                </div>
              </div>
              <div>
                <div className={styles.guaranteeStatValue}>90 j</div>
                <div className={styles.guaranteeStatLabel}>
                  d’accompagnement & de suivi hebdomadaire
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.grid2}>
            ...
            <div className={cn(styles.card, styles.lift)}>
              ...
              <p className={styles.cardText}>
                <Strong>80 $ / heure</Strong> — pour toute évolution postérieure (Phase 2 du cahier
                des charges : messagerie enrichie, planning, multi-villes…).
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="s6" data-dc-section className={cn(styles.section, styles.sectionB)}>
        <div className={styles.container}>
          <SectionHeader
            ...
            lead="Livraison sous 50 jours à compter de la date de démarrage (réception de l’acompte + réunion de cadrage). Réalisation itérative, avec validation du Client à chaque étape clé."
          />
          ...
          <InfoBox icon="i" title="Recette, publication & calendrier détaillé">
            La phase finale (≈ J42 – J50) couvre les tests qualité, les corrections et la
      ...
      <section id="s7" data-dc-section className={cn(styles.section, styles.sectionA)}>
        <div className={styles.container}>
          ...
          <ul className={styles.arrowList}>
            ...
            <li className={styles.arrowItem}>
              Créer un compte <Strong>Stripe</Strong> et fournir un accès pour l’intégration du
              paiement web.
            </li>
            <li className={styles.arrowItem}>
