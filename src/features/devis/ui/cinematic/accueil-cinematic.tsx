...
const diff: ReadonlyArray<Diff> = [
  ...
  {
    h: "140+ projets livrÃ©s",
    p: "Une Ã©quipe expÃ©rimentÃ©e qui sait Ã©viter les piÃ¨ges et livrer.",
  },
  {
    h: "FiÃ¨rement montrÃ©alaise",
    p: "ProximitÃ©, mÃªme fuseau horaire, conformitÃ© Loi 25 native.",
  },
                ...
                <Reveal direction="right">
                  <div>
                    <p style={{ fontSize: 18, color: "var(--text)", lineHeight: 1.66, margin: 0 }}>
                      ...
                      concevons, dÃ©veloppons et maintenons des systÃ¨mes en production â€”
                      applications mobiles, plateformes web, CRM et ERP sur mesure.
                    </p>
                    <p
                      style={{
                        fontSize: 16,
                    ...
                    >
                      ...
                      gÃ©nÃ¨rent des revenus et que nous accompagnons sur la durÃ©e.
                    </p>
                  </div>
                </Reveal>
                <Reveal direction="left" delay={0.1}>
                  <div className={`${styles.glass} ${styles.quoteCard}`}>
                    ...
                    <p className={styles.quoteText}>
                      Un produit qui ne gÃ©nÃ¨re pas de revenus nâ€™est pas livrÃ© â€” il est
                      seulement Ã©crit.
                    </p>
            ...
            <div className={styles.bandInner}>
              ...
              <Reveal delay={0.12}>
                <p className={styles.lead}>
                  Lâ€™expertise dâ€™une Ã©quipe senior et un accompagnement business complet, du
                  cadrage jusquâ€™au lancement â€” au prix dâ€™un lancement, pas dâ€™une ESN.
                </p>
              </Reveal>
                ...
                >
                  <div>
                    ...
                    <div className={styles.moreLabel}>
                      projets livrÃ©s Ã  ce jour â€” ceci nâ€™est quâ€™un aperÃ§u de nos
                      rÃ©alisations.
                    </div>
                  </div>
